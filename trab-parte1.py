...
def create_muscle():
    ...
    if not os.path.isfile("C:\\Users\Pedro\Desktop\laboratorios\TrabalhoLBFinal\Phylos2.aln"):
        muscle_exe = r"C:\Users\Pedro\Desktop\laboratorios\TrabalhoLBFinal\muscle.exe"
        infile1 = r"C:\Users\Pedro\Desktop\laboratorios\TrabalhoLBFinal\Phylos2.faa"
        outfile1 = r"C:\Users\Pedro\Desktop\laboratorios\TrabalhoLBFinal\Phylos2.aln"
            ...
            if 'product' in lista:
                    ...
                    if 'exception' in lista:
                        ...
                        if not os.path.isfile(fname):
                               ...
                               # ft=open("Phylo\\" +  protein_id + ".txt","w")
                                 # f.writelines(self.conteudo)
                                  
                               
                                result_handle=open("Blasts\\" +  protein_id + ".xml")
                                ...
                                for blast_record in blast_records:
                                        for alignment in blast_record.alignments:
                                            for hsp in alignment.hsps:
                                                    if i<5:
                                              #  ft.write('****Alignment****')
                                                            ft.write('>'+alignment.title.split('Rec')[0]+'\n')
                                               # ft.write('length:'+ str(alignment.length))
                                               # ft.write('score:'+ str(hsp.score))
                                               # ft.write('gaps:'+ str(hsp.gaps))
                                                            ft.write(hsp.query[0:90]+'\n')
                                                            #ft.write(hsp.match[0:90] + '\n')
                                              #  ft.write(hsp.sbjct[0:90] + '...')
                                                            i+=1
